...
public class Ex02_PackageUse {
    public static void main(String[] args) {    // Java 프로그램의 시작점
        ...
        Chapter_13.com.study.Banana banana = new Chapter_13.com.study.Banana(); // Banana 클래스의 객체를 생성 - anana 클래스가 Chapter_13.com.study 패키지에 정의되어 있으므로, 패키지 이름을 포함하여 객체를 생성
